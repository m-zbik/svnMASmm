...
\subfigure[Price]{\scalebox{0.33}{\includegraphics[width=1.0\textwidth]{../graphics/Cont-s01-pricesPlot.pdf}}}
    ...
    \mbox{
      \subfigure[Raw and absolute returns.]{\scalebox{0.33}{\includegraphics[width=1.00\textwidth]{../graphics/Cont-s01-returnsPlot.pdf}}}
      \quad
      \subfigure[Returns histogram.]{\scalebox{0.33}{\includegraphics[width=1.00\textwidth]{../graphics/Cont-s01-returnsHistogram.pdf}}}       
      \quad
      \subfigure[Log returns histogram.]{\scalebox{0.33}{\includegraphics[width=1.00\textwidth]{../graphics/Cont-s01-logReturnsHistogram.pdf}}}       
}
    \mbox{
  ...
  \begin{center}
   \mbox{
    ...
    \mbox{
      ...
      \quad
      \subfigure[Log returns histogram.]{\scalebox{0.33}{\includegraphics[width=1.00\textwidth]{../graphics/Cont-logReturnsHistogram.pdf}}}       
}
    \mbox{
...
\begin{figure}[htbp]
  \begin{center}
   \mbox{
      \subfigure[Ask and bid prices.]{\scalebox{0.5}{\quad \quad \includegraphics[width=1.0\textwidth]{../graphics/Farmer-pricesPlot.pdf}}} \quad
  ...
  \begin{center}
   \mbox{
    ...
    \mbox{
      ...
      \quad
      \subfigure[Snapshot of orderbook.]{\scalebox{0.33}{\includegraphics[width=1.00\textwidth]{../graphics/FC-orderbooks.pdf}}}
      \quad
      \subfigure[Autocorrelation of absolute returns.]{\scalebox{0.33}{\includegraphics[width=1.00\textwidth]{../graphics/FC-acfReturns.pdf}}}
      }

...
// rate parameter lambda is the expected number of "events" that occur per unit time
// the return value represents the number of events that "did" happen according to poisson
...
// Returns a value according to an exponential distribution with rate parameter lambda.
